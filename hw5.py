...
# --- MAIN TITLE ---
st.title("Lebanon Tourism Dashboard")
st.markdown("""
This data provides insights into the tourism infrastructure across towns in **Lebanon**. It focuses on highlighting regions with the most hotels and visualizing the relationships between other tourism-related facilities.
""")
...
st.markdown("This chart highlights the towns in Lebanon with the greatest hotel presence.")
...
st.markdown("""
Use the dropdowns below to explore relationships between different tourism infrastructure metrics.  
The bubble size adds a third dimension to the visualization for deeper insight.
""")
